          ...
          Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text('Yagyandatta Murmu',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                  Text('Arth Learner',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold))
                ],
              )
            ],
          ),
